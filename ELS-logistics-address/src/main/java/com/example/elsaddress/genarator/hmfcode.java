package com.example.elsaddress.genarator;
...
public class hmfcode {
    ...
    public static void main(String[] args) {
        String dir = "ELS-logistics-address";
        String parent = "elsaddress";
        // 需要构建一个 代码自动生成器 对象
        ...
        gc.setOutputDir(projectPath+"/"+dir+"/src/main/java");
        gc.setAuthor("洪敏锋");
        gc.setOpen(false);
        ...
        pc.setParent("com.example."+parent);
        pc.setEntity("entity");
        pc.setMapper("mapper");
        ...
        strategy.setInclude("user_address","bs_area","bs_city","bs_street","bs_province");
        // 设置要映射的表名
